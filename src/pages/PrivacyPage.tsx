    ...
    <div className="privacy">
      <div className="row m-0">
        <div className="col-md-12">
          <div className="PrivacyPolicy ibox">
            <h2>Privacy Policy & Cookies Policy</h2>
            <h4>Updated October 13, 2022</h4>
            <p>
              We at 2Cexy (2cexy.com), are committed to protecting any data that
            ...
            <p>
              ...
              ("PI", "Personal Information") of yours is collected, how and when
              we might use your information, who has access to this information,
              and how you can correct any inaccuracies in the information. To
              better protect your privacy, we provide this notice explaining our
              online information practices and the choices you can make about
              the way your information is collected and used. To make this
              notice easy to find, we make it available on our website.
            </p>
            <h3>Information Collected</h3>

            <p>
              We may collect any or all of the information that via both
              ...
              other payment information. All sensitive information is collected
              on a secure server and data is transferred. When transferring
            ...
            <p>
              ...
              unauthorized access to this information. This safeguard may
            ...
            <p>
              ...
              functionality on the Viral Coin website.
            </p>
          </div>
        </div>
      </div>
